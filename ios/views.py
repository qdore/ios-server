...
def getJobInfo(job_id, request):
    ...
    for job in jobs:
		...
		"job_id": job.id,
                ...
                "status": job.status,
                "time": str(job.time),
                "shexiang_num": job.shexiang_num,
                "dengguang_num": job.dengguang_num,
                "luyin_num": job.luyin_num,
                "zimu_num": job.zimu_num,
                "fangxiang_num": job.fangxiang_num,
                "daobo_num": job.daobo_num,
...
def sponseJob(global_params, request, ret_json):
    ...
    job = Job.objects.create(
        ...
        shexiang_num = global_params['shexiang_num'],
        dengguang_num = global_params['dengguang_num'],
        luyin_num = global_params['luyin_num'],
        zimu_num = global_params['zimu_num'],
        fangxiang_num = global_params['fangxiang_num'],
        daobo_num = global_params['daobo_num'],
