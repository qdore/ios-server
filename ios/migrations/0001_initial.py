    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('out_time', models.CharField(max_length=30, verbose_name='\u5916\u51fa\u65f6\u95f4')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.CharField(default='admin', unique=True, max_length=18, verbose_name='\u8eab\u4efd\u8bc1\u53f7')),
                ('work_id', models.CharField(default='admin', unique=True, max_length=20, verbose_name='\u5de5\u53f7')),
                ...
                ('brief', models.CharField(max_length=500, verbose_name='\u7b80\u4ecb')),
                ('token', models.CharField(default=b'144448368718ZacepBrjiCbFGITnKDuQASqXOEoLYHVNtvwRhf', unique=True, max_length=50, verbose_name='Token')),
